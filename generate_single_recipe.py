...
def generate_recipe(groups, prompts, concurrency, name):
    kv_config = "'{\"kv_connector\":\"TPUOffloadConnector\",\"kv_connector_module_path\":\"tpu_inference.offload.tpu_offload_connector\",\"kv_role\":\"kv_both\"}'"
...
name = "qwen3-235b-offload-50g-200p-o2k"
content = generate_recipe(50, 200, 250, name)
